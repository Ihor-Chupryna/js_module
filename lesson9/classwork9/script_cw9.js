...
const simpsonsDiv = document.createElement('div');
...
for (const simpson of simpsons) {
    ...
    simpsonImg.style.height = '250px';
    photoDiv.appendChild(simpsonImg);
...
for (const course of coursesArray) {
    ...
    durationDiv.classList.add('flex');
    let monthDurationH3 = document.createElement('h3');
    monthDurationH3.innerText = `mount: ${course.monthDuration}`;
    let hourDurationH3 = document.createElement('h3');
    hourDurationH3.innerText = `hours: ${course.hourDuration}`;
    durationDiv.append(monthDurationH3, hourDurationH3);
    ...
    courseDiv.append(titleH1, durationDiv, modulesList);
}